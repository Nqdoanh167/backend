 ...
 */
const paymentWithZalo = async (req, res) => {
  const embed_data = {
  ...
  const order = {
    ...
    amount: 50000,
    callback_url: 'https://c20f-2405-4802-1bf3-9b50-4117-f633-e966-25ea.ngrok-free.app/callback',
    description: `D-SHOP - Payment for the order #${transID}`,
    bank_code: '',
  };
...
const callbackWithZalo = (req, res) => {
  let result = {};
